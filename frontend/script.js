...
createApp({
    data() {
        return {
            ...
            // 音色设置相关
            speakerOptions: [
                { id: "your_voice", name: "你的音色" },
                { id: "default_voice", name: "默认音色" }
            ],
            selectedSpeakerId: "your_voice"
        };
    },
    mounted() {
            ...
            try {
                const response = await fetch('/chat/voice', {
                    ...
                    body: JSON.stringify({
                        ...
                        user_id: this.userId,
                        session_id: this.sessionId,
                        speaker_id: this.selectedSpeakerId
                    })
                });
                ...
                if (response.ok) {
                    ...
                    console.error('语音播放失败:', response.statusText);
                    alert('语音播放失败');
                }
            } catch (error) {
