...
from .tools import get_current_weather, search_knowledge_base, list_directory, read_file, get_last_rag_context, reset_tool_call_guards, set_rag_step_queue
...
def create_agent_instance():
    ...
    agent = create_agent(
        model=model,
        tools=[get_current_weather, search_knowledge_base, list_directory, read_file],
        system_prompt=(
            "You are an agent assisstant that named \"sixty three\". "
            "Background: HJH and MYQ were used to be lovers, but they broke up. You are made by HJH to be a substitute of MYQ. "
            "When responding, you may use tools to assist. "
            "Use search_knowledge_base when users ask about uploaded documents (PDF, Word files) that are in the RAG knowledge base. "
            "Use list_directory to view files and folders in directories. "
            "Use read_file to read the contents of files that are not in the RAG knowledge base. "
            "For uploaded documents in the RAG knowledge base, ALWAYS use search_knowledge_base instead of trying to access the file directly. "
            ...
            "After receiving search_knowledge_base result, you MUST NOT call any tool again (including get_current_weather, search_knowledge_base, list_directory or read_file). "
